...
void markdown_output(MMIOT *doc, request_rec *r)
{
    ...
    ap_rputs("<head>\n", r);
    if (conf->head_html)
      ap_rprintf(r,"%s",(char *)conf->head_html);
...
static const char *set_markdown_body_class(cmd_parms * cmd, void *conf, const char *arg)
{
    markdown_conf *c = (markdown_conf *) conf;
    c->body_class = arg;
    return NULL;
...
static const char *set_markdown_head_html(cmd_parms * cmd, void *conf, const char *arg)
{
    markdown_conf *c = (markdown_conf *) conf;
    c->head_html = arg;
    return NULL;
...
static const command_rec markdown_cmds[] = {
    ...
    AP_INIT_TAKE1("MarkdownFlags", set_markdown_flags, NULL, OR_ALL,
                  "set Discount flags"),
    AP_INIT_TAKE1("MarkdownBodyClass", set_markdown_body_class, NULL, OR_ALL,
                  "set Markdown body class"),
    AP_INIT_TAKE1("MarkdownHeadHtml", set_markdown_head_html, NULL, OR_ALL,
                  "set Markdown HTML for HEAD"),
    {NULL}
};
